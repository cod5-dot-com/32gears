...
#include "../arch/i386/mbr.h"
#include "../arch/i386/vbr.h"
#include "vhd.h"
#include "../include/fat32.h"
/*#define VBR_OFFSET 63 */
#define VBR_OFFSET 2048 
...
int mkvhd_main (int argc, char *argv[])
{
	...
	fat32_set_mbr(mbr, VBR_OFFSET, s - VBR_OFFSET - 16); 
	fwrite(mbr, 1, 512, out); 
	o++;
	o += mkvhd_pad(out, VBR_OFFSET - 1);
	printf("jml %d\n", o);
	fat32_set_vbr_sect(vbr, VBR_OFFSET, s - VBR_OFFSET - 16); 
